          ...
          >
            ...
            >
              ...
              <Dropdown
                ...
                class="mt-4"
              />
              <Checkbox v-model:checked="form.is_head" label="Заведующий отделения" class="mt-4" />
...
<script setup lang="ts">
  ...
  import { IDoctor, iDropdownItem } from '@/types'
  ...
  const props = defineProps({
    data: {
      type: Object as PropType<IDoctor | null>,
      default: null
    }
  })
  ...
  watchEffect(() => {
    ...
    form.is_head = props.data?.is_head || false
